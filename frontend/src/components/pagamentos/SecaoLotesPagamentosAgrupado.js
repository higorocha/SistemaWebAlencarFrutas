          ...
          >
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <Tooltip title={`Lotes de turma de colheita liberados: ${estatisticas.lotesLiberados || 0}`}>
                ...
                <Tooltip title={`Lotes de turma de colheita rejeitados: ${estatisticas.lotesRejeitados || 0}`}>
